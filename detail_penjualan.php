                        ...
                        <div class="col-md-6">
                            <form class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control form-control-sm" type="text" value="<?= $datas['kd_jual']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Tanggal</label>
                                    <div class="col-sm-10">
                                        <input class="form-control form-control-sm" type="text" value="<?= $datas['tanggal']; ?>" readonly>
                                    </div>
                                </div>
                            </form>
                            <hr>
                            ...
                            <form method="post">
                                <div class="row">
                                    <div class="col-sm-5 form-group">
                                        <input class="form-control" name="kode" type="text" placeholder="Scan Barcode" required autofocus>
                                    </div>
                                    <div class="col-sm-1 form-group">
                                        <button type="submit" name="cari" class="btn btn-md btn-primary"><i class="fa fa-search"></i></button>
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <button type="button" class="btn btn-md btn-success" data-toggle="modal" data-target=".bd-example-modal-lg">Cari Barang</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2 form-group">
                                            ...
                                            <input name="kd_kitab" class="form-control" type="text" placeholder="Kode Barang" value="<?= $ktb['kd_kitab']; ?>" readonly>
                                        </div>
                                        <div class="col-sm-4 form-group">
                                            <label for="">Nama Barang</label>
                                            <input class="form-control" type="text" placeholder="Nama Barang" value="<?= $ktb['nama']; ?>" readonly>
                                        </div>
                                        <div class="col-sm-2 form-group">
                                            <label for="">Harga</label>
                                            <input class="form-control" type="text" placeholder="Harga Satuan" value="<?= rupiah($ktb['harga_jual']); ?>" readonly>
                                        </div>
                                        <div class="col-sm-1 form-group">
                                            <label for="">Stok</label>
                                            <input class="form-control" type="text" placeholder="Stok" value="<?= $ktb['stok']; ?>" readonly>
                                        </div>
                                        <div class="col-sm-2 form-group">
                                            <label for="">QTY</label>
                                            <input class="form-control" type="number" placeholder="QTY" name="jumlah" required>
                                        </div>
                                        <div class="col-sm-1 form-group">
                                            <label for="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                            <button class="btn btn-success" name="simpan" type="submit"><i class="fa fa-plus"></i></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="hapus_detail_jual.php?id=<?= $data['id_dtj']; ?>" onclick="return confirm('Yakin Akan Menghapus Data Ini ?')" class="btn btn-danger btn-xs" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash font-14"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                            ...
                            <div class="col-md-6 mt-3">
                                <form class="form-horizontal" action="" method="POST" name="autoSumForm">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" value="<?= $datas['jml_jual']; ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="hidden" name="total" value="<?= $datas['total']; ?>" onFocus="startCalc();" onBlur="stopCalc();" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover table-sm" id="example-table2" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Kode Barang</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="" method="post">
                                                ...
                                                <button type="submit" name="pilih" class="btn btn-success btn-primary btn-sm"><i class="fa fa-check"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                <?php } ?>
