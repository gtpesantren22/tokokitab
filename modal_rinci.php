                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="ibox bg-danger color-white widget-stat">
                                <div class="ibox-body">
                                    <h3 class="m-b-5 font-strong"><?= rupiah($keluar['jml']) ?></h3>
                            ...
                            <div class="ibox bg-warning color-white widget-stat">
                                <div class="ibox-body">
                                    <h3 class="m-b-5 font-strong">
                                        <?= rupiah($masuk['jml'] - ($df['nominal'] + $keluar['jml'])); ?></h3>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    Morris.Bar({
                        ...
                        xkey: 'y',
                        ykeys: ['Pemasukan', 'Pengeluaran', 'Penjualan', 'Kolakan'],
                        labels: ['Pemasukan', 'Pengeluaran', 'Penjualan', 'Kolakan']
                    });
                    </script>
                </div>
            </div>
