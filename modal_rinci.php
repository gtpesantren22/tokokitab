...
$masuk = mysqli_fetch_assoc(mysqli_query($conn, "SELECT IF(SUM(nominal) IS null, 0, SUM(nominal)) as jml FROM masuk WHERE kategori = '$kd' "));
$keluar = mysqli_fetch_assoc(mysqli_query($conn, "SELECT IF(SUM(nominal) IS null, 0, SUM(nominal)) as jml FROM keluar WHERE kategori = '$kd' "));

$sql3 = mysqli_query($conn, "SELECT *, IF(SUM(total) IS null, 0, SUM(total)) as jml FROM detail_jual WHERE kategori = '$kd' ");
$jual = mysqli_fetch_assoc($sql3);
$sql4 = mysqli_query($conn, "SELECT *, IF(SUM(total) IS null, 0, SUM(total)) as jml FROM detail_kolakan WHERE kategori = '$kd' ");
$kolak = mysqli_fetch_assoc($sql4);
$sql5 = mysqli_query($conn, "SELECT *, IF(SUM(debet) IS null, 0, SUM(debet)) as jml, IF(SUM(kredit) IS null, 0, SUM(kredit)) as jmlKurang FROM jasa WHERE kategori = '$kd' ");
