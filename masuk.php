...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            ...
            <button type="button" class="btn btn-primary  btn-rounded pull-right" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa ti-plus"> Tambah Pemasukan</i></button>
        </div>
        <div class="ibox-body">
            <br>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $data['ket']; ?></td>
                                <td>
                                    <a href="<?= 'hapus.php?kd=masuk&id=' . $data['id_masuk'] ?>" onclick="return confirm('Yakin Menghapus Data Ini?')" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Del</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
